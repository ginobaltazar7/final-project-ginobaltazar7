...
class StoreOwnerComponent extends Component {
  ...
  componentDidMount() {
    let newStoreCreatedEvent = this.props.marketplace.MEWNewStoreCreated();
  ...
  getStoreAddresses() {
    this.props.marketplace.MEWfetchStoreAddressesByOwner
  ...
  createNewStore() {
    ...
    this.setState({loading: true}, () => {
      this.props.marketplace.MEWcreateNewStore.sendTransaction(
